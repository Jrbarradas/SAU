 <h1 class="display-3">
  ...
  <div style="margin-top: 20px" class="list-group">
    ...
    <button type="button" class="list-group-item">4. Em intervalo de tempo, selecione a opção "Todo o Período" e "Todas as
      opções".</button>
    <button type="button" class="list-group-item">Vide o exemplo abaixo.</button>
  </div>
  </div>
  </center>
    ...
    <script>
       ...
       $('#confirmar').on('click', function(){
         ...
         if(btnSitesEspecificos.checked){
           $("#conteudo").load("./procedimentos/rede/rede_cabo/procedimento_2_sites_especificos.php");
         }else if(btnTodosOsSites.checked){
           $("#conteudo").load("./procedimentos/rede/rede_cabo/procedimento_2_todos_os_sites.php");
         }else if(btnProblemaResolvido.checked){
           $("#conteudo").load("./procedimentos/rede/rede_cabo/procedimento_2_problema_solucionado.php");
         }else{
