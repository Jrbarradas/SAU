...
<!-- End Breadcrumbs -->
  ...
  <section class="inner-page">
    ...
    <table class="table" id="tblinvHWBasic" style="text-align:center">
        ...
        <!-- Modal Botões Inventário - ADD - IMPORT - EXPORT -->
            ...
            <div class='modal-dialog modal-lg' role='document'>
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modalHWAddInvDellPC">Adicionar Computador</h5>
                ...
                <li class="list-group-item"><p class="font-italic">Informações Gerais</p><div class='input-group'>
                        ...
                        <div class='input-group'>
                         ...
                         <input type='text' class='form-edit' id='txtUUID' required>
                         ...
                         </li><li class="list-group-item"><p class="font-italic">Informações da Aquisição</p><div class='input-group'>
                         <div class='input-group-prepend'>
                         ...
                         <span class='input-group-text' style='margin-left:20px'>Vigência</span>
                         <input type='text' class='form-edit' style='width:20%' id='txtVig' required>
                         </li><li class="list-group-item"><p class="font-italic">Tipo de Suporte e Softwares embarcados</p><div class='input-group'>
                         <div class='input-group-prepend'>
                         <span class='input-group-text'>Suporte</span>
                         <input type='text' class='form-edit' style='width:20%' id='txtSup' required>
                         <span class='input-group-text' style='margin-left:20px'>S.O</span>
                         <input type='text' class='form-edit' style='width:40%' id='txtSO' required>
                         <span class='input-group-text' style='margin-left:20px'>Office</span>
                         <input type='text' class='form-edit' style='width:58%' id='txtOffice' required></li>
            ...
            for($i=0;$i<count($sauInv->resDec);$i++){ 
                ...
                echo '<h5 class="modal-title" id="viewDesktopDellTitle">Inventário Hardware - Desktops Dell</h5>'.PHP_EOL;
                ...
                echo "</li>".PHP_EOL;
                 ...
                 echo "<div class='input-group'>
                         ...
                         <span class='input-group-text'>UUID</span>
                         ".PHP_EOL;
                 echo "<input type='text' class='form-edit' id='txtUUID".$sauInv->resDec[$i]->patrimonio."'value='".$sauInv->resDec[$i]->uuid."' required>".PHP_EOL;
                 ...
                 echo "<span class='input-group-text' style='margin-left:20px'>Vigência</span>".PHP_EOL;
                 echo "<input type='text' class='form-edit' style='width:20%' id='txtVig".$sauInv->resDec[$i]->patrimonio."'value='".$sauInv->resDec[$i]->vigencia."'value='".$sauInv->resDec[$i]->vigencia."' required>".PHP_EOL;
                 echo "</li>".PHP_EOL;

                 //Suporte - Sistema Operacional, Office
                 echo '<li class="list-group-item"><p class="font-italic">Tipo de Suporte e Softwares embarcados</p>'.PHP_EOL;
                 echo "<div class='input-group'>
                         <div class='input-group-prepend'>
                         <span class='input-group-text'>Suporte</span>
                         ".PHP_EOL;
                         echo "<input type='text' class='form-edit' style='width:20%' id='txtSup".$sauInv->resDec[$i]->patrimonio."'value='".$sauInv->resDec[$i]->suporte."'value='".$sauInv->resDec[$i]->suporte."' required>".PHP_EOL;
                 echo "<span class='input-group-text' style='margin-left:20px'>S.O</span>".PHP_EOL;
                 ...
                 echo "<span class='input-group-text' style='margin-left:20px'>Office</span>".PHP_EOL;
                 echo "<input type='text' class='form-edit' style='width:58%' id='txtOffice".$sauInv->resDec[$i]->patrimonio."'value='".$sauInv->resDec[$i]->office."'value='".$sauInv->resDec[$i]->office."' required>".PHP_EOL;
                 echo "</li>".PHP_EOL;
