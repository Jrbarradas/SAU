...
<div style="margin-top: 10px " class="list-group">
  <button type="button" class="list-group-item">Neste caso é necessário seguir os seguintes passos:</button>
  <button type="button" class="list-group-item">Coletar fotos do erros, do equipamento e do patrimônio.</button>
  <button type="button" class="list-group-item">Abrir um chamado de Padronização de Equipamento no Redmine.</button>
  <button type="button" class="list-group-item">Levar o equipamento até um assistência e solicitar a formatação do mesmo.</button>
</div>
...
<center>
  ...
  <div style="margin-top: 10px" class="form-group">
    ...
    Procedimentos Realizados (Protocolo 051):
    - Problema de NO BOOT;
    - Possível problema no Sistema Operacional;
    - Necessário a formatação;
    - Sem técnico no local;
    </textarea>
      <textarea class="form-control" rows="5" id="txtProtocolo"  name="textarea" hidden="true">051</textarea>	
