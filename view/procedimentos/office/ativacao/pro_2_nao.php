...
<div style="margin-top: 10px " class="list-group">
  <button type="button" class="list-group-item">Verificado Office informa que irá expirar.</button>
  <button type="button" class="list-group-item">Verificado office não Ativado.</button>
</div>
...
<center>
  ...
  <div style="margin-top: 10px" class="form-group">
    ...
    Procedimentos Realizados (Protocolo 037):
    - Verificado Office informa que irá expirar;
    - Verificado office não ativado;      
    </textarea>
    <textarea class="form-control" rows="5" id="txtProtocolo"  name="textarea" hidden="true">037</textarea>	
