...
<center>
  ...
  <div style="margin-top: 10px" class="form-group">
    ...
    <textarea class="form-control" rows="5" id="comment">
      Procedimentos Realizados (Protocolo 028):
      - Verificado Lentidão em Geral;
      - Feito procedimento de "Limpeza de Arquivos temporários"
      - Problema Persiste;      
    </textarea>
    <textarea class="form-control" rows="5" id="txtProtocolo"  name="textarea" hidden="true">028</textarea>	
