...
?>
	...
	<div style="margin-top: 10px " class="list-group">
		...
		<button type="button" class="list-group-item">Não possível realizar procedimento.</button>
	</div>
	</div>
	<center>
		...
		<div style="margin-top: 10px" class="form-group">
			...
			Procedimentos Realizados (Protocolo 030):
			- Verificado problema relacionado ao relógio;
			- Não possível realizar procedimento;				
			</textarea>
			<textarea class="form-control" rows="5" id="txtProtocolo"  name="textarea" hidden="true">030</textarea>	
