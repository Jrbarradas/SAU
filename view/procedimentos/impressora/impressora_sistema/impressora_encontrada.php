...
<div style="margin-top: 10px " class="list-group">
  ...
  <button type="button" class="list-group-item">Impressora reconhecida no sistema.</button>
</div>
...
<center>
  ...
  <div style="margin-top: 10px" class="form-group">
    ...
    Procedimentos Realizados (Protocolo 046):
    - Verificado problema relacionada a parte de sistema
    - Impressora não realiza nenhuma função;
    - Impressora reconhecida no sistema;      
    </textarea>
    <textarea class="form-control" rows="5" id="txtProtocolo"  name="textarea" hidden="true">046</textarea>	
