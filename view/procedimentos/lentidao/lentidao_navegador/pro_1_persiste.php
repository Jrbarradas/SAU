...
<center>
  ...
  <div style="margin-top: 70px" class="form-group">
    ...
    Procedimentos Realizados (Protocolo 022):
    - Verificado Lentidão apenas no navegador;
    - Feito procedimento de Limpeza de histórico;
    - Problema persiste;      
    </textarea>
    <textarea class="form-control" rows="5" id="txtProtocolo"  name="textarea" hidden="true">022</textarea>	
