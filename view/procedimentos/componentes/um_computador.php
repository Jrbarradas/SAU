...
<div style="margin-top: 0px " class="list-group">
  <button type="button" class="list-group-item">Feito teste da peça com defeito em outro computador, peça funciona normalmente.</button>
</div>
<center>
...
Procedimentos Realizados (Protocolo 016):
- Feito teste da peça com defeito em outro computador;
- Verificado que em outro computador peça funciona normalmente;      
    </textarea>
  </div>
    <textarea class="form-control" rows="5" id="txtProtocolo"  name="textarea" hidden="true">016</textarea>	
