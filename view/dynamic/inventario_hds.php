...
<section class="breadcrumbs">
    ...
    <div class="d-flex justify-content-between align-items-center" style="margin-top:0px">
        <h2>Inventário de Hardware - HD Externo</h2>
        <ol>
        <li><a href="home.php">Home</a></li>
        <li>Inventário de Hardware - HD Externo</li>
        </ol>
    </div>
    </div>
</section>
<!-- End Breadcrumbs -->
  ...
  <section class="inner-page">
    ...
    <table class="table" id="tblHDBasic" style="text-align:center">
 ...
 <div class="modal fade" id="modalHWAddInvDellPC" tabindex="-1" aria-labelledby="modalHWAddInvDellPC" aria-hidden="true">
            <div class='modal-dialog modal-lg' role='document'>
                ...
                <li class="list-group-item"><p class="font-italic">Informações Gerais</p><div class='input-group'>
                        ...
                        <input type='text' class='form-edit' style='width:40%' id='txtHD' required>
            ...
            for($i=0;$i<count($sauInv->resDec);$i++){ 
                ...
                echo '<h5 class="modal-title" id="viewDesktopDellTitle">Inventário Hardware - HD Externo</h5>'.PHP_EOL;
                ...
                echo "<span class='input-group-text' style='margin-left:20px'>Disco</span>";
                echo "<input type='text' class='form-edit' style='width:40%' id='txtHD".$sauInv->resDec[$i]->patrimonio."'value='".$sauInv->resDec[$i]->disco."' required>".PHP_EOL;
                echo "</li>".PHP_EOL;
