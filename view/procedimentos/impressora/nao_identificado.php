...
<div style="margin-top: 10px " class="list-group">
  <button type="button" class="list-group-item">Impressora</button>
  <button type="button" class="list-group-item">Problema não identificado</button>
</div>
...
<center>
  ...
  <div style="margin-top: 10px" class="form-group">
    ...
    <textarea class="form-control" rows="5" id="txtProtocolo"  name="textarea" hidden="true">048</textarea>	
