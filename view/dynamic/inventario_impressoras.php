...
<section class="breadcrumbs">
    ...
    <div class="d-flex justify-content-between align-items-center" style="margin-top:0px">
        <h2>Inventário de Hardware - Impressoras</h2>
        <ol>
        <li><a href="home.php">Home</a></li>
        <li>Inventário de Hardware - Impressoras</li>
        </ol>
    </div>
    </div>
</section>
<!-- End Breadcrumbs -->
  ...
  <section class="inner-page">
    ...
    <table class="table" id="tblImpressoraBasic" style="text-align:center">
 ...
 <div class="modal fade" id="modalHWAddInvDellPC" tabindex="-1" aria-labelledby="modalHWAddInvDellPC" aria-hidden="true">
            <div class='modal-dialog modal-lg' role='document'>
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modalHWAddInvDellPC">Adicionar Impressora</h5>
                ...
                <li class="list-group-item"><p class="font-italic">Informações Gerais</p><div class='input-group'>
                        ...
                        <div class='input-group'>
                         ...
                         <div class='input-group-prepend'>
                         <span class='input-group-text'>IP LAN</span>
                         <input type='text' class='form-edit' style='width:65%' id='txtIplan' required></li>
            ...
            for($i=0;$i<count($sauInv->resDec);$i++){ 
                ...
                echo '<h5 class="modal-title" id="viewDesktopDellTitle">Inventário Hardware - Impressoras</h5>'.PHP_EOL;
