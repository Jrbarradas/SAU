...
<div style="margin-top: 10px " class="list-group">
  ...
  <button type="button" class="list-group-item">Verificado office Ativado.</button>
</div>
...
<center>
  ...
  <div style="margin-top: 10px" class="form-group">
    ...
    <textarea class="form-control" rows="5" id="comment">
      Procedimentos Realizados (Protocolo 036):
      - Verificado Office informa que irá expirar;
      - Verificado office Ativado;      
    </textarea>
    <textarea class="form-control" rows="5" id="txtProtocolo"  name="textarea" hidden="true">036</textarea>	
