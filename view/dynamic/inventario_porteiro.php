...
<section class="breadcrumbs">
    ...
    <div class="d-flex justify-content-between align-items-center" style="margin-top:0px">
        <h2>Inventário de Hardware - Porteiro Eletrônico</h2>
        <ol>
        <li><a href="home.php">Home</a></li>
        <li>Inventário de Hardware - Porteiro Eletrônico</li>
        </ol>
    </div>
    </div>
</section>
<!-- End Breadcrumbs -->
  ...
  <section class="inner-page">
    <div class="container table-responsive" id="divTable" style="margin-top:-50px">
    <table class="table" id="tblPorteiroBasic" style="text-align:center">
 ...
 <div class="modal fade" id="modalHWAddInvDellPC" tabindex="-1" aria-labelledby="modalHWAddInvDellPC" aria-hidden="true">
            <div class='modal-dialog modal-lg' role='document'>
                ...
                <li class="list-group-item"><p class="font-italic">Informações Gerais</p><div class='input-group'>
                        ...
                        <input type='text' class='form-edit' style='width:40%' id='txtTela' required>
                         ...
                         <input type='text' class='form-edit' style='width:50%' id='txtAqu' required>
                         </li>
            ...
            for($i=0;$i<count($sauInv->resDec);$i++){ 
                ...
                echo '<h5 class="modal-title" id="viewDesktopDellTitle">Inventário de Hardware - Porteiro Eletrônico</h5>'.PHP_EOL;
                ...
                echo "<span class='input-group-text' style='margin-left:20px'>Tela</span>";
                echo "<input type='text' class='form-edit' style='width:40%' id='txtTela".$sauInv->resDec[$i]->patrimonio."'value='".$sauInv->resDec[$i]->tela."' required>".PHP_EOL;
                echo "</li>".PHP_EOL;
                 ...
                 echo "<div class='input-group'>
                         ...
                         <span class='input-group-text'>Aquisição</span>
                         ".PHP_EOL;
                         echo "<input type='text' class='form-edit' style='width:50%' id='txtAqu".$sauInv->resDec[$i]->patrimonio."'value='".$sauInv->resDec[$i]->aquisicao."'value='".$sauInv->resDec[$i]->aquisicao."' required>".PHP_EOL;
                 echo "</li>".PHP_EOL;
