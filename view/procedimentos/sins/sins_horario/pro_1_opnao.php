...
<div style="margin-top: 10px " class="list-group">
  ...
  <button type="button" class="list-group-item">Verificada versão Java, Incorreta.</button>
</div>
...
<center>
  ...
  <div style="margin-top: 10px" class="form-group">
    ...
    Procedimentos Realizados (Protocolo 032):
    - Verificado problema relacionado ao relógio;
    - Feito procedimento de mudança de horário;
    - Problema Persiste;
    - Verificada versão Java, Incorreta;      
    </textarea>
    <textarea class="form-control" rows="5" id="txtProtocolo"  name="textarea" hidden="true">032</textarea>	
