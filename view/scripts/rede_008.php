<?php
   ...
   $ch = curl_init();
    ...
    curl_setopt($ch, CURLOPT_POSTFIELDS, "{\"issue\": {\"project_id\": \"436\", \"subject\":\"[SAU] - REDE 008\", \"priority_id\": 2, \"tracker_id\": 3, \"status_id\": 2, \"description\":\"Verificado encaixe do cabo no Modem ou na entrada de rede do computador, feito reinicialização do modem (Ligar e desligar após 15 segundos), verificado Leds no Modem acesos normalmente, identificada rede no sistema, não está conectada;.\" } }");
