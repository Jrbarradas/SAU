...
<div style="margin-top: 10x " class="list-group">
  ...
  <button type="button" class="list-group-item">Extensão Correta.</button>
</div>
...
<center>
  ...
  <div style="margin-top: 10px" class="form-group">
    ...
    Procedimentos Realizados (Protocolo 034):
    - Verificado problema relacionado as ferramentas do Office;
    - Verificada extensão do office;
    - Extensão Correta;      
    </textarea>
    <textarea class="form-control" rows="5" id="txtProtocolo"  name="textarea" hidden="true">034</textarea>	
