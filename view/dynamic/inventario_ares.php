...
<section class="breadcrumbs">
    ...
    <div class="d-flex justify-content-between align-items-center" style="margin-top:0px">
        <h2>Inventário de Hardware - Ares</h2>
        <ol>
        <li><a href="home.php">Home</a></li>
        <li>Inventário de Hardware - Ares</li>
        </ol>
    </div>
    </div>
</section>
<!-- End Breadcrumbs -->
  ...
  <section class="inner-page">
    ...
    <table class="table" id="tblAresBasic" style="text-align:center">
 ...
 <div class="modal fade" id="modalHWAddInvDellPC" tabindex="-1" aria-labelledby="modalHWAddInvDellPC" aria-hidden="true">
            <div class='modal-dialog modal-lg' role='document'>
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modalHWAddInvDellPC">Adicionar Ares</h5>
                ...
                <li class="list-group-item"><p class="font-italic">Informações Gerais</p><div class='input-group'>
                        ...
                        <span class='input-group-text' style='margin-left:20px'>Potência</span>
                        <input type='text' class='form-edit' style='width:40%' id='txtPotencia' required>
            ...
            for($i=0;$i<count($sauInv->resDec);$i++){ 
                ...
                echo '<h5 class="modal-title" id="viewDesktopDellTitle">Inventário Hardware - Ares</h5>'.PHP_EOL;
                ...
                echo "<input type='text' class='form-edit' style='width:14%' id='txtNome".$sauInv->resDec[$i]->patrimonio."'value='".$sauInv->resDec[$i]->nome."' required>".PHP_EOL;
                echo "</li>";
                ...
                echo "<span class='input-group-text' style='margin-left:20px'>Potência</span>";
                echo "<input type='text' class='form-edit' style='width:40%' id='txtPotencia".$sauInv->resDec[$i]->patrimonio."'value='".$sauInv->resDec[$i]->potencia."' required>".PHP_EOL;
                echo "</li>".PHP_EOL;
