...
<div style="margin-top: 10px " class="list-group">
  <button type="button" class="list-group-item">Verificado Problema ocorre apenas em alguns momentos.</button>
</div>
<center>
  ...
  <div style="margin-top: 10px" class="form-group">
    ...
    <textarea class="form-control" rows="5" id="comment">
     Procedimentos Realizados (Protocolo 018):
     - Verificado Problema ocorre apenas em alguns momentos;
    </textarea>
  </div>
  <textarea class="form-control" rows="5" id="txtProtocolo"  name="textarea" hidden="true">018</textarea>	
