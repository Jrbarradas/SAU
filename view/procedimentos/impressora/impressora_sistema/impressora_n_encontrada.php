...
<div style="margin-top: 10px " class="list-group">
  ...
  <button type="button" class="list-group-item">Impressora não realiza nenhuma função.</button>
  <button type="button" class="list-group-item">Impressora não reconhecida no sistema.</button>
</div>
...
<center>
  ...
  <div style="margin-top: 10px" class="form-group">
    ...
    <textarea class="form-control" rows="5" id="comment">
      Procedimentos Realizados (Protocolo 047):
      - Verificado problema relacionada a parte de sistema
      - Impressora não realiza nenhuma função;
      - Impressora não reconhecida no sistema;      
    </textarea>
    <textarea class="form-control" rows="5" id="txtProtocolo"  name="textarea" hidden="true">047</textarea>	
