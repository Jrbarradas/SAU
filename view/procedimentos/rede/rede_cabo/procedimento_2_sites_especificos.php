...
<div style="margin-top: 30px " class="list-group">
  ...
  <button type="button" class="list-group-item">Verificado Problema Ocorre em Sites específicos.</button>
</div>
<center>
  ...
  <div style="margin-top: 20px" class="form-group">
    ...
    Procedimentos Realizados (Protocolo 009):
    ...
    - Verificado Problema Ocorre em Sites específicos;      
    </textarea>
  </div>
    <textarea class="form-control" rows="5" id="txtProtocolo"  name="textarea" hidden="true">009</textarea>	
    ...
    <button style=" margin-top:10px; margin-left: 10px" type="button" class="btn btn-secondary disabled" data-toggle="tooltip" data-placement="top"
