...
<div style="margin-top: 10px " class="list-group">
  ...
  <button type="button" class="list-group-item">Copiar o Log e abrir um chamado no Redmine para a T.I.</button>
</div>
...
<center>
  ...
  <div style="margin-top: 10px" class="form-group">
    ...
    Procedimentos Realizados (Protocolo 049):
    - Problema de NO BOOT;
    - Possível problema no Hardware;
    - No Device Bootable Found ou Hard Disk Not Found (Possível problema no HD);
    - Sem técnico no local;
    </textarea>
      <textarea class="form-control" rows="5" id="txtProtocolo"  name="textarea" hidden="true">049</textarea>	
