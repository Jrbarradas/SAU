...
<div style="margin-top: 10px " class="list-group">
  <button type="button" class="list-group-item">Neste caso, o erro de NO BOOT é causado pelo sistema operacional.</button>
  <button type="button" class="list-group-item">Peça para que o técnico do local realize a formatação do mesmo.</button>
  <button type="button" class="list-group-item">Em caso de dúvidas o mesmo pode entrar em contato com o suporte da Dell.</button>
...
<center>
  ...
  <div style="margin-top: 10px" class="form-group">
    ...
    Procedimentos Realizados (Protocolo 052):
    - Problema de NO BOOT
    - Possível problema no Sistema Operacional
    - Necessário formatação do equipamento
    - Passado link para contado com a Dell;
    </textarea>
      <textarea class="form-control" rows="5" id="txtProtocolo"  name="textarea" hidden="true">052</textarea>	
