...
<section class="breadcrumbs">
    ...
    <div class="d-flex justify-content-between align-items-center" style="margin-top:0px">
        <h2>Inventário de Hardware - Smartphones</h2>
        <ol>
        <li><a href="home.php">Home</a></li>
        <li>Inventário de Hardware - Smartphones</li>
        </ol>
    </div>
...
<!-- End Breadcrumbs -->
  ...
  <section class="inner-page">
    ...
    <table class="table" id="tblSmartBasic" style="text-align:center">
        ...
        <!-- Modal Botões Inventário - ADD - IMPORT - EXPORT -->
            ...
            <div class='modal-dialog modal-lg' role='document'>
                ...
                <li class="list-group-item"><p class="font-italic">Informações Gerais</p><div class='input-group'>
                        ...
                        <input type='text' class='form-edit' style='width:40%' id='txtEntrada' required>
                         ...
                         <span class='input-group-text' style='margin-left:20px'>IMEI 2</span>
                         <input type='text' class='form-edit' style='width:40%' id='txtIMEIdois' required>
            ...
            for($i=0;$i<count($sauInv->resDec);$i++){ 
                ...
                echo '<h5 class="modal-title" id="viewDesktopDellTitle">Inventário Hardware - Smartphones</h5>'.PHP_EOL;
                ...
                echo "</li>".PHP_EOL;
                 ...
                 echo "<span class='input-group-text' style='margin-left:20px'>IMEI 2</span>".PHP_EOL;
                 echo "<input type='text' class='form-edit' style='width:40%' id='txtIMEIdois".$sauInv->resDec[$i]->patrimonio."'value='".$sauInv->resDec[$i]->imeidois."' required>".PHP_EOL;
