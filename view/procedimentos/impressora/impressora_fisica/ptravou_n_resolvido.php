...
<center>
  ...
  <div style="margin-top: 10px" class="form-group">
    ...
    Procedimentos Realizados (Protocolo 040):
    - Verificado problema relacionada a parte física;
    - Verificado papel "travou" no meio da impressão;
    - Feito procedimento para retirar papel da impressora
    - Problema não Solucionado;      
    </textarea>
    <textarea class="form-control" rows="5" id="txtProtocolo"  name="textarea" hidden="true">040</textarea>	
