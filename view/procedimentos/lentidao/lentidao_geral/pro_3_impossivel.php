...
<div style="margin-top: 10px " class="list-group">
  ...
  <button type="button" class="list-group-item">Não possível realizar nenhum procedimento.</button>
</div>
</div>
<center>
  ...
  <div style="margin-top: 10px" class="form-group">
    ...
    <textarea class="form-control" rows="5" id="comment">
      Procedimentos Realizados (Protocolo 027):
      - Verificado Lentidão em Geral;
      - Não possível realizar nenhum procedimento;      
    </textarea>
    <textarea class="form-control" rows="5" id="txtProtocolo"  name="textarea" hidden="true">027</textarea>	
